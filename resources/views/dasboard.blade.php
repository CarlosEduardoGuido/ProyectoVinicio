        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="{{ route('usuarios') }}" class="nav-item nav-link"><i class="bi bi-people-fill me-2"></i>Usuarios</a>
                    <a href="{{ route('citas') }}" class="nav-item nav-link active"><i class="bi bi-calendar-date-fill me-2"></i>Citas</a>
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2" src="{{asset('images/icon.png')}}" alt="" style="width: 40px; height: 40px;">
                            <span class="d-none d-lg-inline-flex">Cirujano Dentista</span>
                        </a>
