<div class="wp-block-group__inner-container">
                      ...
                      <p>
                        Consultorio  Smile\'s, con domicilio en antonio albarran #315 Col.
                        Lazaro Cardenas TOLUCA, EDOMEX y portal de internet
                        https://CONSULTORIOSIMLE\'S.COM.MX, es el responsable
                        del uso y protección de sus datos personales, y al
                      ...
                      <p>
                        Datos de identificación y contacto, Datos sobre
                        características físicas, Datos patrimoniales y/o
                        financieros<br />
                      </p>
                      <p>
                        <br />Además de los datos personales mencionados
                        anteriormente, para las finalidades informadas en el
                        presente aviso de privacidad utilizaremos los siguientes
                        datos personales considerados como sensibles, que
                        requieren de especial protección:
                      </p>
                      <p>Datos de salud<br /></p>
                      <p>
                        <br /><br /><strong
                          >¿Cómo puede acceder, rectificar o cancelar sus datos
                          personales, u oponerse a su uso o ejercer la
                          revocación de consentimiento?</strong
                        >
                      </p>
                      <p>
                      ...
                      <p>
                        ...
                        debe enviar una petición vía correo electrónico a
                        al221810690@gmail.com y deberá contener:
                      </p>
                      <ul>
                      ...
                      <p>
                        ¿En cuántos días le daremos respuesta a su solicitud?<br />5
                        días
                      </p>
                      <p>
                        d) ¿Por qué medio le comunicaremos la respuesta a su
                        solicitud?<br />al221810690@gmail.com
                      </p>
                      <p>
                        <strong
                      ...
                      <p>
                        ...
                        utilizamos cookies, web beacons u otras tecnologías, a
                        través de las cuales es posible monitorear su
                        comportamiento como usuario de internet, así como
                        brindarle un mejor servicio y experiencia al navegar en
                        nuestra página. Los datos personales que obtenemos de
                        estas tecnologías de rastreo son los siguientes:
                      </p>
                      <p>
                        Identificadores, nombre de usuario y contraseñas de
                        sesión, Tipo de navegador del usuario, Fecha y hora del
                        inicio y final de una sesión de un usuario<br />
                      </p>
                      <p>
                        Estas cookies, web beacons y otras tecnologías pueden
                        ser deshabilitadas. Para conocer cómo hacerlo, consulte
                        el menú de ayuda de su navegador. Tenga en cuenta que,
                        en caso de desactivar las cookies, es posible que no
                        pueda acceder a ciertas funciones personalizadas en
                        nuestros sitio web.
                      </p>
                      <p>
                        <strong
                          >¿Cómo puede conocer los cambios en este aviso de
                          privacidad?</strong
                        >
                      </p>
                      <p>
                        ...
                        de nuestras prácticas de privacidad; de cambios en
                        nuestro modelo de negocio, o por otras causas. Nos
                        comprometemos a mantener actualizado este aviso de
                        privacidad sobre los cambios que pueda sufrir y siempre
                        podrá consultar las actualizaciones que existan en el
                        sitio web https://CONSULTORIOSIMLE\'S.COM.MX.
                      </p>
                      <p id="aviso-format">
                        Última actualización de este
                        <a
                          aria-label="aviso de privacidad (opens in a new tab)"
                          rel="noopener"
                          href="https://markethax.com/generador-aviso-de-privacidad/"
                          target="_blank"
